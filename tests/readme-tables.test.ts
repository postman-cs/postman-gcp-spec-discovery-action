...
describe('README action tables', () => {
  it('GCP-DOCS-001: README names the ten v1 providers and the non-goals', () => {
    ...
    for (const provider of ['api-gateway', 'cloud-endpoints', 'apigee', 'api-hub', 'apigee-registry', 'app-integration', 'connectors-custom', 'apigee-portal', 'vertex-extensions', 'agent-engines', 'dialogflow-tools', 'ces-toolsets', 'iac-local']) {
