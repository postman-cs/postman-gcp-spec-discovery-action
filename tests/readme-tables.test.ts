...
describe('README action tables', () => {
  it('GCP-DOCS-001: README names the seven v1 providers and the non-goals', () => {
    const readme = readFileSync(resolve(repoRoot, 'README.md'), 'utf8');
    for (const provider of ['api-gateway', 'cloud-endpoints', 'apigee', 'api-hub', 'app-integration', 'connectors-custom', 'iac-local']) {
